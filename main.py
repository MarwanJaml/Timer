...
def count_down(count):
    ...
    if count > 0:
        ...
        start_timer()
        marks = ""
        w_sessions=math.floor(reps/2)
        for i in range(w_sessions):
            marks += "✔"
...
title_l=Label (text="timer",fg=GREEN,bg=YELLOW,font=(FONT_NAME,50))
title_l.grid(column=1,row=0)

canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)
#tomato_image =PhotoImage(file="img.jpg")
